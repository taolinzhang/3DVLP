...
RAW_REFERIT3D = os.path.join(CONF.PATH.REFERIT3D, "nr3d.csv")
PARSED_REFERIT3D_train = os.path.join(CONF.PATH.REFERIT3D, "nr3d_train.json") # split
PARSED_REFERIT3D_val = os.path.join(CONF.PATH.REFERIT3D, "nr3d_val.json") # split
