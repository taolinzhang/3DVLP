...
PARSED_REFERIT3D_train = os.path.join(CONF.PATH.REFERIT3D, "sr3d_train.json") # split
PARSED_REFERIT3D_val = os.path.join(CONF.PATH.REFERIT3D, "sr3d_val.json") # split
