...
RAW_REFERIT3D = os.path.join(CONF.PATH.REFERIT3D, "sr3d+.csv")
PARSED_REFERIT3D_train = os.path.join(CONF.PATH.REFERIT3D, "sr3d_plus_train.json") # split
PARSED_REFERIT3D_val = os.path.join(CONF.PATH.REFERIT3D, "sr3d_plus_val.json") # split
